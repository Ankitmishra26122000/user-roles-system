...
import { UpdatePasswordDialog } from "../user/update-password-dialog"

export function StoreOwnerHeader() {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Manage your store and view customer feedback</p>
            </div>
          </div>
